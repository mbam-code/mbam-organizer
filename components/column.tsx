    ...
    <div className="shrink-0 w-72 flex flex-col bg-gray-50 dark:bg-gray-900 rounded-md shadow-sm border dark:border-gray-700">
      ...
      {showColorPicker && (
        <div className="p-3 border-b dark:border-gray-700 bg-gray-50 dark:bg-gray-900">
          <h4 className="font-medium text-xs dark:text-gray-200 mb-2">Column Color</h4>
          ...
          >
            ...
            {isAddingTask ? (
              <div className="mt-2 p-3 bg-white dark:bg-gray-800 rounded-md shadow-sm border dark:border-gray-700">
                <Label htmlFor="task-title" className="dark:text-gray-200 text-sm">
                  Task Title
                </Label>
                <Input
                  id="task-title"
                ...
                />
                <Label htmlFor="task-description" className="dark:text-gray-200 text-sm">
